...
function MyForm() {
    return (
        <div className="text-lg">This is a dynamic form inside the modal!</div>
    );
}

function ComponentB() {
    return <div className="text-lg text-blue-500">Switched to Component B</div>;
}
    ...
    return (
        <div className="flex flex-col min-h-screen bg-white ">
            ...
            <header className="sticky top-0 z-50 w-full border-b  border-gray-800 bg-white     ">
                <div className="container mx-auto px-4 h-16 flex items-center justify-between">
                    <div className="flex items-center">
                        <a href="/" className="flex items-center space-x-2">
                            <img
                                src="/static/logo-reservation.jpeg"
                                className="h-[42px]"
                            />
                        </a>
                    </div>
                    ...
                    <div className="hidden md:flex items-center space-x-4">
                      {!user ? <><Link href={route('login')} className="inline-block px-3 py-1.5 text-sm font-medium text-gray-700  hover:text-gray-200 rounded-md hover:bg-teal-700transition-colors">
                            Sign In
                        </Link>
                        <Link href='/register' className="inline-block px-3 py-1.5 text-sm font-medium bg-teal-500 text-white  hover:text-teal-bg-teal-500 hover:bg-gray-200 rounded-md transition-colors">
                        Sign Up
                ...
                {mobileMenuOpen && (
                    <div className="md:hidden border-t border-gray-800 bg-white  py-4">
                            ...
                            <div>
                                ...
                                <ul className="space-y-3">
                                    ...
                                    <li className="flex items-start gap-2">
                                        ...
                                        <span className=" text-gray-100">
                                            Complete order history at your
                                            fingertips
                                        </span>
                                    </li>
                                    <li className="flex items-start gap-2">
            ...
            <footer className="bg-white  border-t  border-gray-800 py-6">
                <div className="container mx-auto px-4 text-center">
                    <p className="text-gray-600 ">
                        © {new Date().getFullYear()} Our Service. All rights
                        reserved.
                    </p>
                </div>
            </footer>
